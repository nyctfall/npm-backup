# **NPM Pkg Packer – An NPM Pkg Backup Tool**

## **Install:**
---
```bash
    $ npm install --global npm-pkg-packer@alpha
```
...
---
- [Install](#install)
- [Pre-Alpha Specification](#basic-pre-alpha-implementation-specification)
- [Project Specification](#project-goal)
- [](#)
- [](#)
- [](#)
- [](#)
...
## [Project's Guiding Princeples—"The UNIX Philosophy":](https://en.wikipedia.org/wiki/Unix_philosophy)
...
## **Basic Pre-Alpha Implementation Specification:**
---
...
## **TODO:**
---
- [x] Write initial spec in README.md.
...
- [ ]
- [ ]
- [ ] Bash version for Bash shell, Zsh shell, and Windows GitBash.
...
# Raw Transcibal of notes:

## NPM Super Pack: Automated NPM backup script.
...
#### File System Operations and The Operations Queue:
...
- A local offline registry server to use as an install location, to be seemlessly integrated with the pkg mgr, like `npm install`.
