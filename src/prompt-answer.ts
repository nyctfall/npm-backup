...
export type PromptOptionalYes = 
 LongOptionalYes | 
 ShortOptionalYes

// combined default yes:
export type PromptDefaultYes = 
 LongDefaultYes | 
 ShortDefaultYes

// combined long yes:
export type PromptLongYes = 
 LongDefaultYes | 
 LongOptionalYes

// combined short yes:
export type PromptShortYes = 
 ShortDefaultYes | 
 ShortOptionalYes

// combined yes choice:
export type PromptYes = 
 PromptOptionalYes | 
 PromptDefaultYes | 
 PromptLongYes | 
 PromptShortYes
...
export type PromptOptionalNo = 
 LongOptionalNo | 
 ShortOptionalNo

// combined default no:
export type PromptDefaultNo = 
 PromptLongDefaultNo | 
 PromptShortDefaultNo 

// combined long no:
export type PromptLongNo = 
 PromptLongDefaultNo | 
 LongOptionalNo 

// combined short no:
export type PromptShortNo = 
 PromptShortDefaultNo | 
 ShortOptionalNo

// combined no choice:
export type PromptNo = 
 PromptDefaultNo | 
 PromptOptionalNo | 
 PromptLongNo | 
 PromptShortNo
...
type OrderedPrompt<LeftChoice extends string, RightChoice extends string> = `${Question} (${LeftChoice}${PromptDivider}${RightChoice})${PromptDelimiter}`
type UnorderedPrompt<Choice1 extends string, Choice2 extends string> = OrderedPrompt<Choice1, Choice2> | OrderedPrompt<Choice2, Choice1>
...
export type PromptAnswerAllVersions = 
 PromptAnswerDefault | 
 PromptAnswerOptional | 
 PromptAnswerLong | 
 PromptAnswerShort
